...
export type MessagingRegistration = {
  ...
  twilio: {
    ...
    subaccountCreatedAt: string | null;
    ...
    authorizedRep2EndUserSid: string | null;
    addressSid: string | null;
    supportingDocumentSid: string | null;
    profileEvaluationSid: string | null;
    ...
    a2pEndUserSid: string | null;
    a2pEvaluationSid: string | null;
    a2pTrustProductStatus: string | null;
    a2pFailureReasons: string[];
    brandSid: string | null;
    brandStatus: string | null;
    brandFailureReason: string | null;
    brandIdentityStatus: string | null;
    brandSubmittedAt: string | null;
