    ...
    <div className={cn("fixed inset-y-0 right-0 left-60 z-50 flex min-h-screen", comparePageBg)}>
      <main className="flex min-w-0 flex-1 flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto px-4 py-2.5">
          ...
          {error && (
            <p className="rounded-lg border border-red-200 bg-red-50 px-3.5 py-2 text-[13px] text-red-700">
              {error}
            </p>
          )}
              ...
              <div className="space-y-3">
                <div className="grid gap-3 xl:grid-cols-12">
                  <div className="space-y-2.5 xl:col-span-9">
                    ...
                    <div className={cn(compareCardClass, "flex flex-wrap items-center justify-between gap-2 px-3.5 py-2")}>
...
function ScanSelectCard({
  ...
  return (
    <div className={cn(compareCardClass, "min-w-0 flex-1 p-3.5")}>
      <div className="flex items-start justify-between gap-2">
        {sectionLabel ? (
