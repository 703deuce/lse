...
export function GridCompareCellTable({
  ...
  return (
    <div className={compareCardClass}>
      <div className="flex flex-wrap items-center justify-between gap-2 border-b border-zinc-200 px-3.5 py-2">
      ...
      <div className="max-h-64 overflow-auto">
        <table className="w-full text-left text-[11px]">
          <thead className="sticky top-0 bg-zinc-50 text-[10px] font-semibold uppercase tracking-wide text-zinc-500">
            <tr>
              <th className="px-3.5 py-2">Cell</th>
          ...
          <tbody>
            {filtered.map((c) => {
              ...
              return (
                ...
                >
                  <td className="px-3.5 py-2 font-semibold text-zinc-900">{c.label}</td>
                  <td className="px-3.5 py-2 text-zinc-500">{formatLocation(c.lat, c.lng)}</td>
                  <td className="px-3.5 py-2 font-medium text-zinc-800">{rankLabel(c.rankA)}</td>
                  <td className="px-3.5 py-2 font-medium text-zinc-800">{rankLabel(c.rankB)}</td>
