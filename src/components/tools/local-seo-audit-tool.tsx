    ...
    >
      <div className="grid gap-5 lg:grid-cols-[0.9fr_1.1fr]">
        ...
        <div className="rounded-2xl border border-[#E6EAF0] bg-[#F9FAFB] p-4">
          {result ? (
            <>
              <div className="mb-4 flex flex-wrap gap-3 rounded-xl border border-[#E6EAF0] bg-white px-3 py-2.5 text-[12px] font-semibold text-[#344054]">
                <span>
                ...
                <span>{result.business.review_count ?? 0} Reviews</span>
                <span className="text-[#D0D5DD]">·</span>
                <span>{result.categories.profile?.good ?? 0} Profile wins</span>
                <span className="text-[#D0D5DD]">·</span>
                <span>{result.to_fix.length} To fix</span>
              </div>
              ...
              <p className="mt-4 text-[12px] text-[#667085]">{result.upgrade_hint}</p>
