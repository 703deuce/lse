/**
 * Capture org Reports page (mockup restyle) with top-to-bottom scroll segments.
 */
...
const OUT = "/opt/cursor/artifacts/screenshots/mockup-verify/reports-org";
const URL = "http://localhost:3000/dev/org-reports-preview";
...
async function main() {
  ...
  await page.waitForSelector("text=Main Locations", { timeout: 60000 });
